...
using RingRouting.ExpermentsResults.Lifetime;
...
namespace RingRouting.Dataplane
{
    ...
    public class PublicParameters
    {
        ...
        public static int InitialRingCount { get; set; }
        ...
        public static List<Sensor> PreRingNodesHolder = new List<Sensor>(); // The set of all ring nodes ordered from anchor Anti-Clockwise by on hop
        ...
        public static List<Cluster> networkClusters = new List<Cluster>();
        ...
        public static List<Cluster> currentNetworkTree = new List<Cluster>();
      ...
      //  public static double ControlPacketsPercentage { get { return 100 * (NumberofControlPackets / NumberofGeneratedPackets); } }
        ...
        #region Delay Track
            ...
            public static double AverageQueryDelay { get { if (NumberOfNodesDissemenating == 0) { return 0; } else { return QueryDelay / NumberOfDelieveredQueryPackets; } } }
        ...
        public static double DropedRatio
        {
            get
            {
                return 100 * (Convert.ToDouble(NumberofDropedPackets) / Convert.ToDouble(NumberofGeneratedDataPackets) + Convert.ToDouble(NumberofGeneratedControlPackets));
            }
        }
