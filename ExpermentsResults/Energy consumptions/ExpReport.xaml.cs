...
namespace RingRouting.ExpermentsResults.Energy_consumptions
{
    class ResultsObject
    {
    ...
    public partial class ExpReport : Window
    {
        ...
        public ExpReport(MainWindow _mianWind)
        {
            ...
            res.AverageEnergyConsumption = PublicParameters.TotalEnergyConsumptionJoule;
            double averageWaitingTime = Convert.ToDouble(PublicParameters.TotalWaitingTime) / NumberofDeliveredPacket;
            res.AverageWaitingTime = averageWaitingTime;
            double avergaeRedundan = Convert.ToDouble(PublicParameters.TotalReduntantTransmission) / NumberofDeliveredPacket;
            ...
            List.Add(new ValParPair() { Par = "Number of Delievered data packets %", Val =PublicParameters.NumberOfDelieveredDataPackets.ToString() });
            ...
            List.Add(new ValParPair() { Par = "Protocol", Val = "RingRouting" });
