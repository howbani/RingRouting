...
using RingRouting.db;
using RingRouting.Intilization;
using RingRouting.Coverage;
using RingRouting.Properties;
using System.Windows.Media;
using System.Windows.Threading;
using RingRouting.Forwarding;
using RingRouting.ExpermentsResults.Energy_consumptions;
using RingRouting.ExpermentsResults.Lifetime;
using RingRouting.ControlPlane.NOS.TC;
using RingRouting.ControlPlane.NOS.TC.subgrapgh;
using RingRouting.DataPlane.NeighborsDiscovery;
using RingRouting.ControlPlane.NOS.FlowEngin;
using RingRouting.ui.conts;
using RingRouting.Charts.Intilization;
using RingRouting.ControlPlane.NOS.Visualizating;
...
namespace RingRouting.ui
{
    ...
    public partial class MainWindow : Window
    {
        ...
        DispatcherTimer TrialTimer = new DispatcherTimer();
        ...
        {
            TrialTimer.Stop();
            //RingNodesFunctions.ChangeRingNode(PublicParameters.RingNodes[3],true);
        }
        ...
        private void Btn_SinkSpeed_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Settings.Default.SinkSpeed = int.Parse(speed);
